...
class PolicyGradient:
    def __init__(
        ...
        self.ep_obs, self.ep_as, self.ep_r = [], [], []
        self._build_net()
    ...
    def _build_net(self):
        ...
        outputs, self.output_state = tf.nn.dynamic_rnn(gru, self.tf_obs, initial_state=self.tf_tile_init_hidden,
                                                       time_major=False)
    ...
    def choose_sampler_action(self, observation):
    ...
    def store_sampler_transition(self, s, a, r):
    ...
    def learn_pretrain_sampler(self, observation, act_prob):
